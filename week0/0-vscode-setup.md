...
[Window installation Video Guide](https://www.youtube.com/embed/wU7IQLIOwoo)
  
[macOS Installation Video Guide](https://www.youtube.com/w0xBQHKjoGo)

## Common Issues

* If you get error related script execution policy, refer to this video guide: [script execution policy video](https://youtu.be/c06Uu5yCetc?t=18).
* Changing the default terminal in VS Code: [change default terminal video](https://youtu.be/c06Uu5yCetc?t=71).
